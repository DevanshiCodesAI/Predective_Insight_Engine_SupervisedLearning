...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0F2027,50:203A43,100:2C5364&height=220&section=header&text=Predictive%20Insight%20Engine&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=House%20Price%20Prediction%20Using%20Supervised%20Learning&descAlignY=60&descSize=18" width="100%"/>
...
[![Jupyter Notebook](https://img.shields.io/badge/Jupyter-Notebook-F37626?style=for-the-badge&logo=jupyter&logoColor=white)](https://github.com/DevanshiCodesAI/Predective_Insight_Engine_SupervisedLearning/blob/main/Predictive_Insight_Engine.ipynb)
[![Machine Learning](https://img.shields.io/badge/Machine-Learning-6C63FF?style=for-the-badge)](https://scikit-learn.org/)
[![Supervised Learning](https://img.shields.io/badge/Supervised-Learning-00A67E?style=for-the-badge)](#-models-implemented)

<br>

<!-- ===================== PROJECT BUTTONS ===================== -->

[![Open Notebook](https://img.shields.io/badge/Open-Jupyter%20Notebook-F37626?style=for-the-badge&logo=jupyter&logoColor=white)](https://github.com/DevanshiCodesAI/Predective_Insight_Engine_SupervisedLearning/blob/main/Predictive_Insight_Engine.ipynb)
[![Open in Colab](https://img.shields.io/badge/Open%20in-Google%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/github/DevanshiCodesAI/Predective_Insight_Engine_SupervisedLearning/blob/main/Predictive_Insight_Engine.ipynb)

<br>

[![Theory PDF](https://img.shields.io/badge/Theory-PDF-E53935?style=for-the-badge&logo=adobeacrobatreader&logoColor=white)](YOUR_THEORY_PDF_LINK)
...
[![View Dataset](https://img.shields.io/badge/Open-Google%20Sheets-34A853?style=for-the-badge&logo=googlesheets&logoColor=white)](https://docs.google.com/spreadsheets/d/1PkMQDotO2G4xUsD8cJ7OFTHStLvU2VE7Ou7_5ktLykM/edit?gid=1756734646#gid=1756734646)
...
flowchart LR
    ...
    G --> H[Evaluate Models]
    H --> I[Bias-Variance Analysis]
    I --> J[Final Conclusion]
```
...
```mermaid
flowchart TD
    A[Real Estate Dataset] --> B[Remove house_id]
    B --> C[Define Features X]
    B --> D[Define Target y]
    C --> E[80% Training Data]
    C --> F[20% Testing Data]
    D --> E
    D --> F
    E --> G1[Simple Linear Regression]
    E --> G2[Multiple Linear Regression]
    E --> G3[Polynomial Regression]
    G1 --> H[Model Evaluation]
    G2 --> H
    G3 --> H
    F --> H
    H --> I[Best Generalizing Model]
```
...
```mermaid
flowchart LR
    A[Underfitting] --> B[Model is too simple]
    B --> C[High training and testing error]

    D[Good Fit] --> E[Balanced complexity]
    E --> F[Low testing error and small score gap]

    G[Overfitting] --> H[Model is too complex]
    H --> I[Low training error but high testing error]
```
...
flowchart TD
    ...
    B --> B1[Uses all training records]
    C --> C1[Uses one training record]
    D --> D1[Uses a small group of records]
```
...
[![Open in Colab](https://img.shields.io/badge/Open%20Notebook-Google%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white)](https://colab.research.google.com/github/DevanshiCodesAI/Predective_Insight_Engine_SupervisedLearning/blob/main/Predictive_Insight_Engine.ipynb)
...
[![GitHub](https://img.shields.io/badge/GitHub-DevanshiCodesAI-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/DevanshiCodesAI)
[![Repository](https://img.shields.io/badge/View-Project%20Repository-6C63FF?style=for-the-badge&logo=github&logoColor=white)](https://github.com/DevanshiCodesAI/Predective_Insight_Engine_SupervisedLearning)
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&height=120&color=0:0F2027,50:203A43,100:2C5364&section=footer" alt="Footer"/>
